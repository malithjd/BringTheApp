  ...
  return (
    <div>
      ...
      <div className="relative">
        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-text2">$</span>
        <input
          type={focused ? 'number' : 'text'}
          inputMode="decimal"
          value={displayValue}
          placeholder={placeholder || '0'}
          className="w-full bg-surface2 text-text rounded-lg pl-7 pr-3 py-3 text-[16px] border border-border focus:border-accent focus:outline-none transition-colors placeholder:text-text2"
