    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-surface border border-border rounded-2xl p-6 shadow-2xl animate-fade-up">
        ...
        <p className="text-text2 text-sm mb-6">
          {mode === 'signin'
            ? 'Access your saved deal reports.'
            : 'Save up to 5 deal reports and compare side by side.'}
        </p>
        ...
        {confirmSent ? (
          <div className="text-center py-4">
            ...
            <p className="text-text2 text-sm">We sent a confirmation link to <span className="text-text">{email}</span></p>
          </div>
        ) : (
